...
const WelcomeUser = (props) => {
  ...
  return(
    ...
    <button className="b-2 m-4  mt-20 px-2 py-8 text-4xl font-bold bg-purple-300 text-white" onClick={props.ClickButton}>Click</button> <br />
    ...
    <button className="b-2 m-4 px-2 py-8 text-4xl font-bold bg-cyan-300 text-white"  onClick={HandleGreeting}>Greeting</button>
    </div>
  )
}
