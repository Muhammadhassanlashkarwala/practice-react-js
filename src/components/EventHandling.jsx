...
function EventHandling() {
    ...
    return(
        ...
        <button className="b-2 mb-4 px-2 py-8 text-4xl font-bold bg-yellow-300 text-white" onClick={handleButtonClick}>Click Me!</button>
        ...
        <button className="b-2 mt-4 px-2 py-8 text-4xl font-bold bg-green-300 text-white" onClick={() =>handleWelcomeUser("Hassan")}>User Button!</button>
        </div>
    );
};
